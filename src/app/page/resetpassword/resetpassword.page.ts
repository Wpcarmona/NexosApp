...
import {FormGroup, FormBuilder, Validators, FormControl, FormsModule, EmailValidator} from '@angular/forms'
...
export class ResetpasswordPage implements OnInit {
  ...
  validationMessages = {
    email: [
      ...
      {type:"pattern", meesage: 'El correo ingresado es incorrecto, intenta de nuevo'}
    ],
 }
  ...
  async presentAlert() {
    const alert = await this.alertController.create({
      ...
      message: 'Se ha enviado un enlace a tu correo, recuerda revisar la bandeja de correos no deseado',
      buttons: ['Ok']
    });
